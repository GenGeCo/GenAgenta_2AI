...
| **Studio Tecnico** | Ufficio di progettazione | Tecnici |
| **Rivendita** | Fornitore materiali (vedi categorie sotto) | Solo Admin |
| **Impresa Edile** | Azienda con classificazione SOA | Titolari impresa |
| **Professionista** | Persona singola con ruolo | Auto-registrazione |

#### 2.2.1 Tipi di PROFESSIONISTA - Tecnico
Sistema a **multi-flag** (uno può avere più qualifiche):

| Flag | Descrizione |
|------|-------------|
| ☐ Architetto | Progettazione, direzione lavori |
| ☐ Ingegnere | Strutture, impianti, progettazione |
| ☐ Geometra | Computi, rilievi, direzione lavori |
| ☐ Consulente | Consulenza tecnica generica |
| ☐ Perito | Perizie, stime |

*Fonte: [Differenze professionisti edilizia - BibLus](https://biblus.acca.it/calcestruzzo-armato-dal-consiglio-di-stato-chiarimenti-su-competenze-di-geometri-ingegneri-ed-architetti/)*

#### 2.2.2 Tipi di PROFESSIONISTA - Applicatore/Esecutore
Sistema a **multi-flag**:

| Flag | Descrizione |
|------|-------------|
| ☐ Muratore | Murature, intonaci, massetti |
| ☐ Imbianchino/Pittore | Tinteggiature, verniciature |
| ☐ Piastrellista | Pavimenti, rivestimenti ceramici |
| ☐ Cartongessista | Sistemi a secco, controsoffitti |
| ☐ Cappottista | Isolamento termico a cappotto |
| ☐ Impermeabilizzatore | Impermeabilizzazioni, guaine |
| ☐ Posatore pavimenti | Parquet, laminati, resine |
| ☐ Elettricista | Impianti elettrici |
| ☐ Idraulico | Impianti idrico-sanitari |

#### 2.2.3 Tipi di IMPRESA EDILE
Sistema semplificato (multi-flag):

| Flag | Descrizione |
|------|-------------|
| ☐ Impresa generale | Costruzioni civili, ristrutturazioni complete |
| ☐ Impresa specializzata | Focus su un tipo di lavorazione |
| ☐ Artigiano/Ditta individuale | Piccole dimensioni |

**Campo opzionale: Certificazione SOA**
> La SOA è una certificazione obbligatoria solo per appalti pubblici >150.000€. Non tutte le imprese ce l'hanno.

Se l'impresa ha SOA, può indicare le categorie:
- **OG** (Opere Generali): OG1 Edifici, OG2 Restauro, OG3 Strade, ecc.
- **OS** (Opere Specializzate): OS6 Finiture, OS8 Impermeabilizzazioni, ecc.

*Fonte: [Categorie SOA - BibLus ACCA](https://biblus.acca.it/categorie-opere-pubbliche-elenco/)*

#### 2.2.4 Tipi di RIVENDITA (Solo Admin)
Sistema a **multi-flag** (una rivendita può vendere più categorie):

| Flag | Descrizione |
|------|-------------|
| ☐ Sistemi a secco | Cartongesso, profili, isolanti |
| ☐ Pitture e vernici | Idropitture, smalti, impregnanti |
| ☐ Isolanti termici | Cappotti, EPS, XPS, lana di roccia |
| ☐ Impermeabilizzanti | Guaine, membrane, additivi |
| ☐ Pavimenti e rivestimenti | Piastrelle, parquet, resine |
| ☐ Malte e massetti | Premiscelati, autolivellanti |
| ☐ Edilizia pesante | Laterizi, cemento, inerti |
| ☐ Ferramenta edile | Fissaggi, utensili, minuteria |
| ☐ Termoidraulica | Caldaie, radiatori, tubazioni |
| ☐ Elettrico | Cavi, quadri, domotica |
...
| Formato | Tipo | Note |
|---------|------|------|
| **DCF** | Binario proprietario ACCA | Formato nativo, non leggibile direttamente |
| **XPWE** | XML di interscambio ACCA | Leggibile, strutturato |
| **XML** | Export generico | Convertibile da DCF |
| **Excel** | Export tabellare | Più semplice da parsare |

### 4.3 Come Funziona il DCF
> ⚠️ Il DCF è **binario**, non è un XML leggibile!

**Strategia di import:**
1. L'utente ha un file .dcf (computo/capitolato)
2. Lo apre con **PriMus-DCF** (software ACCA gratuito)
3. Esporta in **XML o XPWE**
4. La nostra app importa l'XML/XPWE

**Oppure (più semplice):**
1. L'utente esporta da Primus in **Excel**
2. La nostra app importa l'Excel

*Fonte: [Come scambiare file PriMus - BibLus](https://biblus.acca.it/come-scambiare-file-di-primus/)*

### 4.4 Prezzari Regionali Gratuiti
I prezzari ufficiali sono scaricabili gratis da [Prezzari-net ACCA](https://www.acca.it/prezzari-opere-edili):
- Ogni regione pubblica il suo annualmente
- Disponibili in formato DCF
- ~12 milioni di voci tra materiali e lavorazioni
- Possiamo usarli come base per il nostro database cicli

### 4.5 Cosa Importiamo da Primus
- **Capitolati**: lista lavorazioni con prezzi
- **Voci di computo**: singole lavorazioni con misurazioni
- **Categorie/Sottocategorie**: struttura ad albero delle lavorazioni

### 4.6 Filosofia di Integrazione
...
### 10.4 Database Cicli
L'AI propone cicli da un **database predefinito** allineato ai prezzari regionali italiani:

**Categorie principali** (come da prezzari Emilia-Romagna, Puglia, Marche):

| Codice | Categoria | Esempi lavorazioni |
|--------|-----------|-------------------|
| A.07 | **Murature e Tramezzi** | Murature portanti, tramezze, tamponamenti |
| A.13 | **Impermeabilizzazioni** | Guaine, membrane, trattamenti |
| A.17 | **Intonaci** | Civili, rustici, premiscelati |
| A.19 | **Pavimenti** | Piastrelle, massetti, sottofondi |
| A.23 | **Tinteggiature** | Idropitture, smalti, decorativi |
| E.11 | **Isolamenti** | Cappotto, coibentazioni, acustici |
| M.03 | **Rivestimenti** | Ceramici, in pietra, speciali |

*Fonte: [Prezzari regionali - ACCA](https://www.acca.it/prezzari-regionali)*

**Struttura di un CICLO:**
```
Ciclo {
    id
    nome                    // "Rasatura parete fessurata"
    categoria               // A.17 Intonaci
    descrizione_problema    // "Fessurazioni non strutturali < 3mm"
    fasi: [
        { ordine: 1, descrizione: "Apertura fessure", materiali: [...] },
        { ordine: 2, descrizione: "Stuccatura", materiali: [...] },
        { ordine: 3, descrizione: "Applicazione rete", materiali: [...] },
        { ordine: 4, descrizione: "Rasatura finale", materiali: [...] }
    ]
    keywords_ai             // ["crepe", "fessure", "muro rotto", "spacchi"]
}
```

- L'AI NON inventa cicli, li cerca per keywords e propone
- I cicli sono creati/validati dai vostri esperti
- Possibilità futura: import da prezzari DCF Primus
...
ACCA promuove l'interoperabilità tramite IFC (standard openBIM), non tramite DCF direttamente